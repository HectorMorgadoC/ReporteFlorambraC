...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        const response = await fetch('https://floriambra-reporte-ra8r3fbgh-hectors-projects-f934d335.vercel.app/order', {
            method: 'GET'
        });
...
document.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch(`https://floriambra-reporte-ra8r3fbgh-hectors-projects-f934d335.vercel.app/order/${orderReports}`,
        { method:'GET'});
